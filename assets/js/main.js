...
document.addEventListener("DOMContentLoaded", () => {
  ...
  /**
   * JavaScript for triggering translation based on language selection
   */
  document
    .getElementById("translateToSpanish")
    .addEventListener("click", function () {
  ...
  document
    .getElementById("translateToFrench")
    .addEventListener("click", function () {
      googleTranslateElementInit(
        {
          pageLanguage: "en",
  ...
  document
    .getElementById("translateToChinese")
    .addEventListener("click", function () {
      googleTranslateElementInit(
        {
          pageLanguage: "en",
  ...
  document
    .getElementById("translateToEnglish")
    .addEventListener("click", function () {
      googleTranslateElementInit(
        {
          pageLanguage: "en",
  ...
  document.addEventListener("DOMContentLoaded", function () {
    const spanishLink = document.getElementById("translateToSpanish");
    const frenchLink = document.getElementById("translateToFrench");
    const chineseLink = document.getElementById("translateToChinese");
    const englishLink = document.getElementById("translateToEnglish");

    // Add click event listeners to each language link
    spanishLink.addEventListener("click", function () {
      changeLanguage("es"); // 'es' represents Spanish
    });

    frenchLink.addEventListener("click", function () {
      changeLanguage("fr"); // 'fr' represents French
    });

    chineseLink.addEventListener("click", function () {
      changeLanguage("zh-CN"); // 'zh-CN' represents Chinese
    });

    englishLink.addEventListener("click", function () {
      changeLanguage("en"); // 'en' represents English
    });
  });
